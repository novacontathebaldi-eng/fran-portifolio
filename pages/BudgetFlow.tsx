...
import { Check, MapPin, CreditCard, Calendar } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pt-24 pb-24 bg-gray-50">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="flex justify-between mb-8 md:mb-12 relative">
          ...
          {steps.map((s, idx) => (
            <div key={idx} className="relative z-10 flex flex-col items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors ${step > idx + 1 ? 'bg-green-500 text-white' : step === idx + 1 ? 'bg-black text-white' : 'bg-white text-gray-400 border border-gray-200'}`}>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-12 animate-fadeIn">
          ...
          {step === 1 && (
            <div>
              ...
              <div className="mt-8 flex justify-end">
                <button onClick={nextStep} className="w-full md:w-auto bg-black text-white px-8 py-3 rounded-full hover:bg-accent transition text-center">Continuar</button>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div>
              ...
              <div className="mt-8 flex justify-between gap-4">
                ...
                <button onClick={nextStep} className="bg-black text-white px-6 md:px-8 py-3 rounded-full hover:bg-accent transition flex-grow md:flex-grow-0">Revisar Detalhes</button>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <button className="border-2 border-black rounded-lg p-4 flex flex-row md:flex-col items-center justify-center md:justify-center gap-2 bg-gray-50">
                    <CreditCard className="w-6 h-6" />
                    <span className="text-sm font-bold">Cartão</span>
                  </button>
                  <button className="border border-gray-200 rounded-lg p-4 flex flex-row md:flex-col items-center justify-center md:justify-center gap-2 hover:border-gray-400">
              ...
              <div className="mt-8 flex justify-between gap-4">
                <button onClick={prevStep} className="text-gray-500 hover:text-black">Voltar</button>
                <button onClick={nextStep} className="bg-black text-white px-6 md:px-8 py-3 rounded-full hover:bg-accent transition w-full md:w-auto text-sm md:text-base">Confirmar Solicitação</button>
              </div>
            </div>
          )}
          ...
          {step === 4 && (
            <div className="text-center py-12">
               ...
               <div className="flex flex-col gap-4 items-center">
                 <Link to="/profile" className="bg-black text-white px-8 py-3 rounded-full hover:bg-accent transition w-full md:w-auto text-center">
                   Ir para Meu Painel
                 </Link>
