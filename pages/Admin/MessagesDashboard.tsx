                                                ...
                                                >
                                                    <div className="pt-4 pl-14">
                                                        ...
                                                        <div className="flex gap-2 justify-end">
                                                            ...
                                                            {msg.phone && (
                                                                <a
                                                                    href={`https://wa.me/${msg.phone.replace(/\D/g, '')}?text=${encodeURIComponent(`Olá ${msg.name}! Recebemos sua mensagem e estamos entrando em contato. 😊`)}`}
                                                                    target="_blank"
                                                                    rel="noreferrer"
                                                                    onClick={(e) => {
                                                                        e.stopPropagation();
                                                                    ...
                                                                    className="px-3 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-2 text-white hover:scale-105 active:scale-95"
                                                                    style={{
