          ...
          >
            ...
            <div className="bg-[#111] text-white p-4 flex justify-between items-center shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-serif font-bold text-sm tracking-wide">{settings.chatbotConfig?.botName || (settings.branding?.brandShortName ? `Assistente ${settings.branding.brandShortName}` : 'Assistente Virtual')}</h3>
      ...
      <AnimatePresence mode="wait">
        {!isOpen && (!hideButton || forceShow) && (
          <motion.button
            ...
            title={settings.chatbotConfig?.botName || "Assistente Virtual"}
          >
